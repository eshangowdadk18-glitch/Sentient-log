  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 selection:bg-white/30">
      ...
      >
        ...
        <h2 className="text-2xl font-semibold text-center text-zinc-100 mb-2">Welcome back</h2>
        <p className="text-zinc-500 text-center mb-8">Sign in to your SentientLog account</p>
        ...
        <p className="text-zinc-500 text-center mt-8 text-sm">
          Don't have an account? <Link to="/register" className="text-zinc-300 hover:text-white transition-colors underline decoration-white/30 underline-offset-4">Create one</Link>
        </p>
      </motion.div>
    </div>
  );
